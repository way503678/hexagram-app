...
const styles = StyleSheet.create({
  ...
  weekCell: { width: `${100 / 7}%`, textAlign: "center", color: colors.subtle, fontSize: 12, paddingVertical: 4 },
  ...
  dnumWrap: { width: 22, height: 22, alignItems: "center", justifyContent: "center" },
  todayWrap: { backgroundColor: "#333", borderRadius: 11 },
  dnum: { fontSize: 15, fontWeight: "700", color: "#333" },
  todayNum: { color: "#fff" },
  gz: { fontSize: 10, lineHeight: 11, width: 11, textAlign: "center" },
  lunar: { fontSize: 10, color: colors.subtle, marginTop: 1 },
  jqInCell: { color: "#7a3b9e", fontWeight: "700" },
  zb: { marginTop: 2, alignSelf: "flex-start", borderRadius: 3, paddingHorizontal: 4, paddingVertical: 1 },
  zbBorder: { borderWidth: 0.5, borderColor: "#bbb" },
  zbTxt: { fontSize: 11, fontWeight: "700" },
  detail: {
